...
int main()
{
	...
	cout << " the period. (This program will use the do-while loop)\n\n";
	...
	do //Do this part of the program while the counter for days is <= than the number of days inserted by the user
	{
		...
		cont = cont + 1; //Increase the counter for days
	} while (cont <= numberdays);
