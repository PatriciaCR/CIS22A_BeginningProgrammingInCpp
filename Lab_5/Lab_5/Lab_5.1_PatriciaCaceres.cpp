...
int main()
{
	...
	cout << " the period. (This program will use the while loop)\n\n";
	...
	while (cont <= numberdays) //Repeat while counter of days is <= than the number of days inserted by the user.
	{
